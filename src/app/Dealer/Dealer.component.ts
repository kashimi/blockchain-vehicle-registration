...
export class DealerComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      ...
      'dealerName': this.dealerName.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceDealer.updateParticipant(form.get('participantId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.dealerName) {
        formObject.dealerName = result.dealerName;
      } else {
        formObject.dealerName = null;
      }
